...
import {
  ...
  EULabel,
  USLabel,
} from "../../scan/_components/nutrient-label-views";
...
export function CreateFoodPage({
  ...
  useEffect(() => {
    if (!scannedLabel || appliedScanRef.current === scannedLabel) {
      return;
    }
  ...
  return (
    <main className="macros-fixed-inset-x fixed top-0 z-50 flex h-dvh flex-col overflow-hidden bg-background">
        ...
        {step === 1 && (
          <div className="space-y-3">
            ...
            <div className="space-y-1.5">
              ...
              <Input id="create-food-barcode" value={barcode ?? ""} readOnly />
            </div>
          </div>
        )}
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  <Button
                    ...
                    className="w-full"
                    onClick={() =>
                      setServings((current) => [...current, newServingDraft()])
                    }
                  >
