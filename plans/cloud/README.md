...
- **2026-07-25 (010 done)** — UI is consolidated. For plans 012/013:
  ...
  - **Open question for the operator**: `apps/cloud` settings re-enrolls TOTP
    ...
    does call it. Both flows ship as-is. Pick one before cutover — mandatory
    TOTP re-enrollment at cutover (003/012) runs straight through this code.
