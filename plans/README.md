...
| 015 | Comprehensive evolving personal-agent memory | P1 | XL | 014 | IN PROGRESS (2026-07-13: architecture, schemas/models/indexes, governed evidence/audit/job APIs, transactional conversation observation, and server-enforced incognito landed on `feat/personal-agent-memory`; all gates default off and Gate A still needs remaining domain adapters plus deployed 50-event review. Previous Gate C STOP resolved by live MongoDB Community 8.2.11 + self-managed `mongot`; embedding/shadow retrieval implementation resumed.) |
