...
| 007 | Desktop UX fixes + responsive admin implementation (umbrella; phases F1–F7 fixes, R1–R6 = doc's proposed 007–012) | P2 | XL | 005 (006 for CI gates) | IN PROGRESS (2026-06-13: F1–F7 + R1–R5 all DONE. R3 browser seam and R4 responsive desktop sweep landed; R5 converged the web admin on `@repo/ui`, shared editorial headers/shell, and mobile-priority tables. R6 remains — phase statuses + decisions inside the plan file.) |
