...
| 007 | Desktop UX fixes + responsive admin implementation (umbrella; phases F1–F7 fixes, R1–R6 = doc's proposed 007–012) | P2 | XL | 005 (006 for CI gates) | IN PROGRESS (2026-06-13: F1–F7 + R1–R4 + R2 `@repo/ui` all DONE. R3 browser seam: native browser fetch/localStorage/fs fallbacks, 32-route no-mock sweep PASS. R4 responsive sweep: all dashboard routes audited at 375/768/1280 with no document overflow; inbox stacked flow, priority tables/lists, settings/forms, and explicit kanban/calendar/whiteboard mobile calls landed. R5 and R6 remain — phase statuses + decisions inside the plan file.) |
