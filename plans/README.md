...
| 015 | Comprehensive evolving personal-agent memory | P1 | XL | 014 | BLOCKED (2026-07-13: architecture, schemas/models/indexes, governed evidence/audit/job APIs, transactional conversation observation, and server-enforced incognito landed on `feat/personal-agent-memory`; all gates default off and Gate A still needs remaining domain adapters plus deployed 50-event review. STOP at Gate C: production MongoDB Community 7.0.30 has no bounded Vector Search; requires approved MongoDB 8.2+/Atlas/backend decision.) |
